...
class Post(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="作者",related_name='owner_related',default='')
    is_hot = models.BooleanField(default=False, verbose_name="是否热门")   # 手动热门推荐

    # pv = models.IntegerField(default=None,verbose_name="",auto_created=True)  # 浏览量
    add_date = models.DateTimeField(auto_now_add=True, verbose_name="添加时间")
    pub_date = models.DateTimeField(auto_now=True, verbose_name="修改时间")
...
class SideBar(models.Model):
    ...
    def get_content(self):
        if self.display_type == 1:
            ...
            return render_to_string('blog/sidebar/popular_post.html', context=context)
        ...
        elif self.display_type == 6:  # 推荐文章
            context = {

            }
            return render_to_string('blog/sidebar/suggest_post.html', context=context)
